$(function() {
  ...
  $(document).on("click", `#SecondContent3`, function(){    
    ...
    $('#product_images_attributes_0__destroy').prop('checked', true);
    ...
    $(document).on("click", `#Delete_btn1`, function(){
      console.log(1)
      $('#product_images_attributes_1__destroy').prop('checked', true);
      $('#SecondContent1 img').attr('src', '/icon_image.png');
      $('#Delete_btn1').hide();
    })

    $(document).on("click", `#Delete_btn2`, function(){
      $('#product_images_attributes_2__destroy').prop('checked', true);
      $('#SecondContent2 img').attr('src', '/icon_image.png');
      $('#Delete_btn2').hide();
    })

    $(document).on("click", `#Delete_btn3`, function(){
      $('#product_images_attributes_3__destroy').prop('checked', true);
  ...
  $(document).on("click", `#SecondContent_nil3`, function(){
    ...
    $(document).on("click", `#Delete_btn_replacement_nil0`, function(){
      ...
      //Inputボックスを再作成
      $('#image-box').append('<input name="product[images_attributes][0][image]" id="product_images_attributes_0_image" type="file">');
      //削除ボタンを削除する      
    ...
    $(document).on("click", `#Delete_btn_replacement_nil1`, function(){
      ...
      //Inputボックスを再作成
      $('#image-box').append('<input name="product[images_attributes][1][image]" id="product_images_attributes_1_image" type="file">');
      //削除ボタンを削除する      
    ...
    $(document).on("click", `#Delete_btn_replacement_nil2`, function(){
      ...
      //Inputボックスを再作成
      $('#image-box').append('<input name="product[images_attributes][2][image]" id="product_images_attributes_2_image" type="file">');
      //削除ボタンを削除する      
    ...
    $(document).on("click", `#Delete_btn_replacement_nil3`, function(){
      ...
      //Inputボックスを再作成
      $('#image-box').append('<input name="product[images_attributes][3][image]" id="product_images_attributes_3_image" type="file">');
      //削除ボタンを削除する      
